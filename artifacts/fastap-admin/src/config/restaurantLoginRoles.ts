...
export const RESTAURANT_LOGIN_ROLES: LoginRoleOption[] = [
  ...
  { role: "reception", label: "Reception", icon: "🛎️", description: "Guests, rooms & folios", demoEmail: "reception@spicegarden.com", defaultPath: "/restaurant/reception" },
  ...
  { role: "bar", label: "Bar", icon: "🍹", description: "Bar & inventory", demoEmail: "bar@spicegarden.com", defaultPath: "/restaurant/bar" },
  { role: "spa", label: "Spa", icon: "💆", description: "Spa bookings", demoEmail: "spa@spicegarden.com", defaultPath: "/restaurant/spa" },
