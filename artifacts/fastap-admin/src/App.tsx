...
function AppRoutes() {
  return (
    ...
    <Switch>
      ...
      {/* Spa Payments now lives inside the Spa page's Payments tab, not as its own sidebar
          item. The old path redirects there so existing links and bookmarks still work. */}
      <Route path="/restaurant/spa-payments">{() => <Redirect to="/restaurant/spa?tab=payments" />}</Route>
