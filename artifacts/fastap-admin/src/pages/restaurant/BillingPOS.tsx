        ...
        {!selectedOrder && !paid ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
            ...
            <div className="flex gap-2 mt-6 w-full">
              <button className="flex-1 py-3 rounded-xl border border-white/10 hover:bg-white/5 text-sm font-semibold flex items-center justify-center gap-2"><Printer className="h-4 w-4" /> Print</button>
          ...
          <>
            <div className="flex items-center justify-between p-4 border-b border-white/5">
              ...
              <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-white/10 text-xs hover:bg-white/5"><Printer className="h-3.5 w-3.5" /> KOT</button>
            </div>
            ...
            <div className="p-4 border-t border-white/5 space-y-2">
              ...
              <div className="flex gap-2">
                <button className="flex-1 py-2 rounded-xl border border-white/10 hover:bg-white/5 text-xs font-semibold flex items-center justify-center gap-1"><Printer className="h-3.5 w-3.5" /> Print Bill</button>
