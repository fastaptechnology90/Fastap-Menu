...
const DEFAULT_PERMISSIONS: Record<string, Record<string, boolean>> = {
  ...
  spa:          { view_orders: true, edit_orders: false, cancel_orders: false, refund_orders: false, add_menu: false, edit_pricing: false, delete_menu: false, hide_menu: false, view_wallet: false, view_settlements: false, view_reports: true, add_staff: false, remove_staff: false, edit_salary: false, edit_stock: true, approve_purchase: false, create_campaigns: false, send_promotions: false, qr_controls: false, nfc_controls: false, printer_settings: true, time_based_access: false, device_based_access: false, branch_wise_access: false, approval_workflows: false, activity_tracking: false },
  housekeeping: { view_orders: true, edit_orders: false, cancel_orders: false, refund_orders: false, add_menu: false, edit_pricing: false, delete_menu: false, hide_menu: false, view_wallet: false, view_settlements: false, view_reports: false, add_staff: false, remove_staff: false, edit_salary: false, edit_stock: false, approve_purchase: false, create_campaigns: false, send_promotions: false, qr_controls: false, nfc_controls: false, printer_settings: false, time_based_access: false, device_based_access: false, branch_wise_access: false, approval_workflows: false, activity_tracking: true },
