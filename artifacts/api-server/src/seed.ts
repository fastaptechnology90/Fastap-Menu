...
export async function runSeed() {
  ...
  if (existingRes.length === 0) {
    ...
    await db.insert(reservationsTable).values([
      { restaurantId: restaurant.id, customerName: "Ali Al-Mansoori", customerPhone: "+971501234001", customerEmail: "ali@example.com", date: today, time: "19:00", guestCount: 4, status: "confirmed", reservationType: "table", zone: "window_side", roomNumber: "R-102", bookingToken: "#REV0001", depositAmount: "500", depositStatus: "paid", notes: "Window table preferred" },
      { restaurantId: restaurant.id, customerName: "Fatima Zahra", customerPhone: "+971501234002", customerEmail: "fatima@example.com", date: today, time: "20:30", guestCount: 2, status: "pending", reservationType: "vip", zone: "vip-lounge", roomNumber: "R-201", bookingToken: "#REV0002", depositAmount: "1000", depositStatus: "pending", specialRequest: "Anniversary dinner" },
      { restaurantId: restaurant.id, customerName: "Corporate Booking", customerPhone: "+971507654321", customerEmail: "corp@example.com", date: tomorrow, time: "13:00", guestCount: 12, status: "confirmed", reservationType: "conference", zone: "conference-room", roomNumber: "Conf-A", bookingToken: "#REV0003", depositAmount: "2000", depositStatus: "paid", notes: "Projector & whiteboard" },
      { restaurantId: restaurant.id, customerName: "James Smith", customerPhone: "+971501234003", customerEmail: "james@example.com", date: tomorrow, time: "18:30", guestCount: 3, status: "confirmed", reservationType: "table", roomNumber: "R-105", bookingToken: "#REV0004", depositAmount: "500", depositStatus: "paid" },
      { restaurantId: restaurant.id, customerName: "Pool Party", customerPhone: "+971501234004", date: tomorrow, time: "14:00", guestCount: 6, status: "pending", reservationType: "pool", zone: "poolside", roomNumber: "Pool-2", bookingToken: "#REV0005", depositAmount: "300", depositStatus: "pending" },
      { restaurantId: restaurant.id, customerName: "Banquet Event", customerPhone: "+971501234005", date: tomorrow, time: "18:00", guestCount: 80, status: "confirmed", reservationType: "banquet", zone: "banquet-hall", roomNumber: "Hall-1", bookingToken: "#REV0006", depositAmount: "10000", depositStatus: "paid", specialRequest: "Celebration event" },
      { restaurantId: restaurant.id, customerName: "Cabana Guest", customerPhone: "+971501234006", date: today, time: "12:00", guestCount: 4, status: "confirmed", reservationType: "cabana", zone: "poolside", roomNumber: "Cab-3", bookingToken: "#REV0007", depositAmount: "1500", depositStatus: "paid" },
      { restaurantId: restaurant.id, customerName: "Hall Booking", customerPhone: "+971501234007", date: tomorrow, time: "11:00", guestCount: 40, status: "pending", reservationType: "hall", zone: "banquet-hall", roomNumber: "Hall-2", bookingToken: "#REV0008", depositAmount: "5000", depositStatus: "pending" },
      { restaurantId: restaurant.id, customerName: "Bar Guest", customerPhone: "+971501234008", date: today, time: "21:00", guestCount: 2, status: "confirmed", reservationType: "bar_table", zone: "Sunset Lounge", roomNumber: "Bar-3", bookingToken: "#BAR0001", depositAmount: "300", depositStatus: "paid", notes: "Bar table: Window Bar T-3" },
      { restaurantId: restaurant.id, customerName: "VIP Lounge Party", customerPhone: "+971501234009", date: tomorrow, time: "22:00", guestCount: 6, status: "confirmed", reservationType: "lounge", zone: "vip_lounge", roomNumber: "VIP-1", bookingToken: "#LOUNGE001", depositAmount: "2000", depositStatus: "pending", notes: "Premium lounge: VIP Premium Lounge. Min spend INR 5000" },
    ]);
